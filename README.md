...
<p align="center">
  ...
  <a href="https://github.com/agentasteriski/Homeserver/blob/master/README.md#requirements">How To Get Started?</a>
</p>
...
For more details per service, [see here](https://github.com/agentasteriski/Homeserver/blob/master/services-apps-configuration.md). 
...
How to prep a USB stick: see [Manjaro First Steps > Using a Live System](https://manjaro.org/support/firststeps/). Further Instructions [here](https://github.com/agentasteriski/manjaro-gnome-post-install#quick-guide).
...
_Turn your system into a modern server with 1 click with [prep_server.sh](https://github.com/agentasteriski/Homeserver/blob/master/prep-server.sh) to automatically or manually install essential tools, apply basic configuration + required stuff for optional docker services._

It is recommended to read through the [prep_server.sh](https://github.com/agentasteriski/Homeserver/blob/master/prep-server.sh) to get an idea what it does and why. 
...
1. Check the [Filesystem Options](https://github.com/agentasteriski/Homeserver/tree/master/Filesystems-guide/Filesystems-options.md). Decide what is best for you. 
2. Follow the [Filesystems Guide](https://github.com/agentasteriski/Homeserver/tree/master/Filesystems-guide)

***

### Step 3. Data Migration
[Data Migration](https://github.com/agentasteriski/Homeserver/blob/master/Filesystems-guide/Data-Migration.md) - Move files to your server data pool.

***

### Step 4 - Network configuration
Before you can access your services outside of your home, [prepare your network](https://github.com/agentasteriski/Homeserver/blob/master/network-configuration.md) and get your own domain. 

***

### Step 5 - Docker Compose Guide - customisation and personalisation
[Docker Compose Guide](https://github.com/agentasteriski/Homeserver/tree/master/docker)
...
[Configure Apps & Services](https://github.com/agentasteriski/Homeserver/blob/master/services-apps-configuration.md) contains direct links to the documentation or homepage of each Docker app. 

***

### Step 7 - Configure & run Backups
Critical to enjoy the benefits of hosting your own server is the reliability of data storage and the ability to quickly recover a system (simply using your docker folder containing the folders you mount into containers). Follow the [Backup Guide](https://github.com/agentasteriski/Homeserver/tree/master/Backups-guide).

***

### Step 8 - Automatic Maintenance and optional manual maintenance
To keep your server purring quietly, without having to spend much or any time keeping it running, follow the [Maintenance Guide](https://github.com/agentasteriski/Homeserver/tree/master/Maintenance-guide) for regular cleanup, updates of server and docker images and filesystem/drive maintenance. 
